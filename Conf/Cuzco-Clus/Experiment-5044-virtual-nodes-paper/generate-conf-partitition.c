...
int main( int argc, char*argv[] )
{
	...
	int nb_of_nodes=5040,nb_of_sockets=nb_of_nodes*sockets_per_node,
...
printf("#Root or Cluster level Layout configuration\n");
	...
	printf("Entity=Cluster Type=Center NumSumNodes=0 NumSumCoresInCluster=0 NumSumSocketsInCluster=0 AllocatedSumNodes=0 AllocatedSumCoresInCluster=0 AllocatedSumSocketsInCluster=0 AllocatedSumThreadsInCluster=0 NumSumThreadsInCluster=0 Enclosed=virtual[0-%d]\n\n",nb_of_nodes-1);
...
//                j= 2*i;
                ...
                printf("Entity=virtual%d type=Node nodecount=1 AllocatedNodeCount=0 NumSumSockets=0 NumSumCoresInNode=0 AllocatedSumSockets=0 AllocatedSumCoresInNode=0 BitmapPosition=0 AllocatedSumThreadsInNode=0 NumSumThreadsInNode=0 Enclosed=socket[%d",i,j);
