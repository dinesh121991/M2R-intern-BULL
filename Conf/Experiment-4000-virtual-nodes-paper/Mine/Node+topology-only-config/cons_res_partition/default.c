...
s_p_options_t entity_options[] = {
	...
	{"AllocatedThreadCount",S_P_UINT32},
	...
	{"threadcount",S_P_UINT32},  // RD_ONLY value never Change.In the core entity only
	...
	{"SelectedThreadCount",S_P_UINT32},
	
	/* Parents aggregated keys */
	
	{"NumSumNodesInCluster", S_P_UINT32},  // It is in Cluster
	{"NumSumCoresInCluster",S_P_UINT32},
	{"NumSumSocketsInCluster",S_P_UINT32},
	{"NumSumThreadsInCluster",S_P_UINT32},
	
	{"NumSumSocketsInNode",S_P_UINT32}, // It is in Node
	{"NumSumCoresInNode",S_P_UINT32},
	{"NumSumThreadsInNode",S_P_UINT32},
	
	{"NumSumCoresInSocket",S_P_UINT32}, //It is in Socket
	{"NumSumThreadsInSocket",S_P_UINT32},

	//  {"NumSumThreadsInCluster",S_P_UINT32}  // If CR_THREAD LEVEL is also useful
	
	{"SelectedSumNodesInCluster", S_P_UINT32},  // It is in Cluster
	{"SelectedSumCoresInCluster",S_P_UINT32},
	{"SelectedSumSocketsInCluster",S_P_UINT32},
	{"SelectedSumThreadsInCluster",S_P_UINT32},
	
	{"SelectedSumSocketsInNode",S_P_UINT32}, // It is in Node
	{"SelectedSumCoresInNode",S_P_UINT32},
	{"SelectedSumThreadsInNode",S_P_UINT32},
	
	{"SelectedSumCoresInSocket",S_P_UINT32},	//It is in Socket
	{"SelectedSumThreadsInSocket",S_P_UINT32},
	
	{"AllocatedSumNodesInCluster", S_P_UINT32},  // It is in Cluster
	{"AllocatedSumCoresInCluster",S_P_UINT32},
	{"AllocatedSumSocketsInCluster",S_P_UINT32},
	{"AllocatedSumThreadsInCluster",S_P_UINT32},
	
	{"AllocatedSumSocketsInNode",S_P_UINT32}, // It is in Node
	{"AllocatedSumCoresInNode",S_P_UINT32},
	{"AllocatedSumThreadsInNode",S_P_UINT32},
	
	{"AllocatedSumCoresInSocket",S_P_UINT32}, //It is in Socket
	{"AllocatedSumThreadsInSocket",S_P_UINT32},
...
const layouts_keyspec_t keyspec[] = {
	...
	{"AllocatedThreadCount",L_T_UINT32},
	...
	{"threadcount",L_T_UINT32},  // RD_ONLY value never Change.In the core entity only
...
/* Selected cores,sockets,nodes information */
	...
	{"SelectedThreadCount",L_T_UINT32},

	/* Parents aggregated keys */
	
	/*{"NumSumNodesInCluster", L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "nodecount"},  // It is in Cluster
	{"NumSumCoresInCluster",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "NumSumCoresInNode"},
	{"NumSumSocketsInCluster",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "NumSumSocketsInNode"},
	{"NumSumThreadsInCluster",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "NumSumThreadsInNode"},*/
	
	{"NumSumSocketsInNode",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "socketcount"}, // It is in Node
	{"NumSumCoresInNode",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "NumSumCoresInSocket"},
	{"NumSumThreadsInNode",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "NumSumThreadsInSocket"},
	
	{"NumSumCoresInSocket",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "corecount"}, //It is in Socket
	{"NumSumThreadsInSocket",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "threadcount"},

/*Free Nodes, Cores details inserted in the beginning aftewards value change update */
	/*{"SelectedSumNodesInCluster", L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "SelectedNodeCount"},  // It is in Cluster
	{"SelectedCoresInCluster",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "SelectedSumCoresInNode"},
	{"SelectedSumSocketsInCluster",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "SelectedSumSocketsInNode"},
	{"SelectedSumThreadsInCluster",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "SelectedSumThreadsInNode"},*/
	
	{"SelectedSumSocketsInNode",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "SelectedSocketCount"}, // It is in Node
	{"SelectedSumCoresInNode",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "SelectedSumCoresInSocket"},
	{"SelectedSumThreadsInNode",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "SelectedSumThreadsInSocket"},
	
	{"SelectedSumCoresInSocket",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "SelectedCoreCount"},	//It is in Socket
	{"SelectedSumThreadsInSocket",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "SelectedThreadCount"},
	
	/*{"AllocatedSumNodesInCluster", L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AllocatedNodeCount"},  // It is in Cluster
	{"AllocatedSumCoresInCluster",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AllocatedSumCoresInNode"},
	{"AllocatedSumSocketsInCluster",L_T_UINT32 ,KEYSPEC_UPDATE_CHILDREN_SUM ,"AllocatedSumSocketsInNode"},
	{"AllocatedSumThreadsInCluster",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AllocatedSumThreadsInNode"},*/
	
	{"AllocatedSumSocketsInNode",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM ,"AllocatedSocketCount"}, // It is in Node
	{"AllocatedSumCoresInNode",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AllocatedSumCoresInSocket"},
	{"AllocatedSumThreadsInNode",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AllocatedSumThreadsInSocket"},
	
	{"AllocatedSumCoresInSocket",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AllocatedCoreCount"}, //It is in Socket
	{"AllocatedSumThreadsInSocket",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AllocatedThreadCount"},

	// topology based Node config	
	//{"SelectedCpuCountInNode",L_T_UINT32},   // SelectedCpuCountInNode is called here SelectedThreadsInNode
	...
	{"NumSumSocketsInLevel0",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "NumSumSocketsInNode"},
	{"NumSumThreadsInLevel0",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "NumSumThreadsInNode"},
	...
	{"SelectedSumSocketsInLevel0",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "SelectedSumSocketsInNode"},
	{"SelectedSumThreadsInLevel0",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "SelectedSumThreadsInNode"}, 	
	...
	{"AllocatedSumSocketsInLevel0",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AllocatedSumSocketsInNode"},
	{"AllocatedSumThreadsInLevel0",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AllocatedSumThreadsInNode"},
	...
	{"NumSumThreadsInLevel1",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "NumSumThreadsInLevel0"},
	...
	{"SelectedSumThreadsInLevel1",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "SelectedSumThreadsInLevel0"}, 	
	...
	{"AllocatedSumThreadsInLevel1",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AllocatedSumThreadsInLevel0"},
	...
	{"NumSumThreadsInLevel2",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "NumSumThreadsInLevel1"},
	...
	{"SelectedSumThreadsInLevel2",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "SelectedSumThreadsInLevel1"}, 	
	...
	{"AllocatedSumThreadsInLevel2",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AllocatedSumThreadsInLevel1"},
	...
	{"NumSumThreadsInLevel3",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "NumSumThreadsInLevel2"},
	...
	{"SelectedSumThreadsInLevel3",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "SelectedSumThreadsInLevel2"}, 	
	...
	{"AllocatedSumThreadsInLevel3",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AllocatedSumThreadsInLevel2"},
