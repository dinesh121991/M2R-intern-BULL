...
//	for( i=1 ; i<4 ; i++ )
	...
	printf("Entity=switch3 Type=Switch AvailableSumNodesInLevel0=0 SwitchToProcessInLevel0=0 AvailableSumCpusInLevel0=0  Enclosed=virtual[0-59]\n");

	printf("Entity=switch4 Type=Switch AvailableSumNodesInLevel0=0 AvailableSumCpusInLevel0=0 SwitchToProcessInLevel0=0 Enclosed=virtual[60-119]\n");

	printf("Entity=switch5 Type=Switch AvailableSumNodesInLevel0=0 AvailableSumCpusInLevel0=0 SwitchToProcessInLevel0=0 Enclosed=virtual[120-179]\n");

	printf("Entity=switch6 Type=Switch AvailableSumNodesInLevel0=0 AvailableSumCpusInLevel0=0 SwitchToProcessInLevel0=0 Enclosed=virtual[180-239]\n");
