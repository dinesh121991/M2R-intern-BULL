...
var v16elu = {
	...
	create_cmElement : function(objIbmEv,objIbmEvAction,cmElement){
		var pageid = "";
		...
		if (typeof (window.pageViewAttributes) != "undefined") {
			...
			pageid = pageid + "-_--_--_-" + window.loadingTime + "-_-" + pageLocation + "-_-" +  window.loadingTime + "-_-" + window.NTPT_IBMer;
		}

		if (typeof cmCreateElementTag !== 'undefined') cmCreateElementTag(objIbmEvAction, objIbmEv, cmElement + "-_--_--_--_--_--_-" + pageid);
	},
...
ibmStats.event = function (obj) {
    ...
    v16elu.create_cmElement(obj.ibmEV,obj.ibmEvAction,cmElement);
};
