...
*/
/*extern void print_part_res_record( part_res_record *prr);
extern void print_part_row_data( part_row_data *prd);
extern void print_node_res_record( node_res_record *nrr);
extern void print_node_use_record( node_use_record *nur);*/
#endif /* !_CONS_RES_H */
